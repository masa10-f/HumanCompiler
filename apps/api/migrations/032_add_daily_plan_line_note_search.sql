-- Migration: Add schedule line notes to notebook search
-- Date: 2026-09-24
-- Description: Include memos written under schedule lines in notebook search text
-- Timed lines and /schedule lines can carry a free-form "note". Index it after the
-- line's other visible text, then rebuild search text so memos saved by a newer
-- API before this migration become searchable. Note content is unchanged.

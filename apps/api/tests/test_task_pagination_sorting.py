...
def test_get_tasks_by_project_has_stable_tiebreaker_across_pages(
    session: Session, test_user_id: str
):
    data = create_test_data(session, test_user_id)
    ...
    first_page = task_service.get_tasks_by_project(
        session,
        project.id,
        test_user_id,
        skip=0,
    ...
    second_page = task_service.get_tasks_by_project(
        session,
        project.id,
        test_user_id,
        skip=100,

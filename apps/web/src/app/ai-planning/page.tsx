...
export default function AIPlanningPage() {
  ...
  const [weeklyReport, setWeeklyReport] = useState<WeeklyReportResponse | null>(
    null,
  );
  ...
  const [selectedSchedule, setSelectedSchedule] =
    useState<SavedWeeklySchedule | null>(null);
    ...
    try {
      ...
      if (weeklyTasksResult.status === "fulfilled") {
        ...
        toast({
          title: "エラー",
          description:
            weeklyTasksResult.reason instanceof Error
  ...
  const deleteSchedule = async (weekStartDate: string) => {
    try {
      ...
      setSavedSchedules((prev) =>
        prev.filter((s) => s.week_start_date !== weekStartDate),
      );
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      value={capacityHours}
                      onChange={(e) =>
                        setCapacityHours(parseInt(e.target.value) || 40)
                      }
                    />
                  </div>
                </div>
                    ...
                    <Card>
                      <CardContent className="pt-6">
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <div className="text-2xl font-bold">
                              {weeklyPlan.total_planned_hours}h
                            </div>
                            <div className="text-xs text-gray-500">
                              計画時間
                            </div>
                      ...
                      <CardContent className="pt-6">
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <div className="text-2xl font-bold">
                              {Math.round(
                                (weeklyPlan.total_planned_hours /
                                  capacityHours) *
                                  100,
                              )}
                              %
                          ...
                          <CardContent className="pt-4">
                            ...
                            <div className="text-xl font-bold text-purple-600">
                              {weeklyPlan.solver_metrics.avg_task_hours
                                ? weeklyPlan.solver_metrics.avg_task_hours.toFixed(
                                    1,
                                  )
                                : "0"}
                              h
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                        ...
                        <Card>
                          <CardContent className="pt-4">
                            ...
                            <div
                              className={`text-xl font-bold ${weeklyPlan.constraint_analysis.overload_risk ? "text-red-600" : "text-green-600"}`}
                            >
                              {weeklyPlan.constraint_analysis.overload_risk
                                ? "高"
                                : "低"}
                            </div>
                          </CardContent>
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2">
                        <Button
                          ...
                          onClick={() => {
                            const dateOnly =
                              schedule.week_start_date?.split("T")[0];
            ...
            {selectedSchedule && (
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  {selectedSchedule.schedule_json.optimization_insights
                    ?.length > 0 && (
                    <div>
                      <h4 className="text-lg font-semibold mb-3">
                        最適化の洞察
                      ...
                      <ul className="space-y-1">
                        {selectedSchedule.schedule_json.optimization_insights.map(
                          (insight, index) => (
                            <li
                              key={index}
                              className="flex items-start gap-2 text-sm"
                  ...
                  {selectedSchedule.schedule_json.project_allocations?.length >
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        {selectedSchedule.schedule_json.project_allocations.map(
                          (allocation, index) => (
                            <div
                              key={index}
                ...
                <CardHeader>
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <CardDescription>
                        {weeklyReport.week_start_date}週（
                        {weeklyReport.week_start_date} ～{" "}
                        {weeklyReport.week_end_date}）の報告書
                      </CardDescription>
                    </div>
                    <Button
